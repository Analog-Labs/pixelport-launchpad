...
- [x] A5: Confirm incident escalation path and founder decision boundaries.
...
- [x] A5-evidence: founder-approved incident/rollback boundary policy (`1A`/`2A`/`3A`) is documented and closed.
