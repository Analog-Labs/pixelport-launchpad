...
- **Session 27 validation status:** `npx tsc --noEmit` passes for the hotfix. Production redeploy and one fresh-tenant validation pass are still required before the duplicate-bootstrap bug can be considered closed.
