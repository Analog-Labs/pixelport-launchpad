...
| MEMORY_OPENAI_API_KEY value is currently invalid | Native-memory search/index quality on fresh tenants; runtime returns OpenAI `401 invalid_api_key` | Founder updates Vercel `MEMORY_OPENAI_API_KEY` with a valid OpenAI project key |
