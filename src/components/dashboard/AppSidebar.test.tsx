 ...
 * Verifies that badge counts from usePaperclipSidebarBadges appear in the sidebar.
 */
...
vi.mock('@/hooks/usePaperclipSidebarBadges', () => ({
  usePaperclipSidebarBadges: useSidebarBadgesMock,
}));
