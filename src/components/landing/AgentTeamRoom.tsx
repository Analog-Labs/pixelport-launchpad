...
const AgentTeamRoom = () => {
  ...
  return (
    <div className="rounded-xl border border-border bg-card overflow-hidden max-w-5xl mx-auto shadow-lg shadow-primary/5">
      {/* Window chrome */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 divide-y lg:divide-y-0 lg:divide-x divide-border">
        ...
        <div className="p-5 sm:p-6">
          ...
          <div className="flex items-center gap-3 mb-4 pb-4 border-b border-border">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-semibold text-foreground">Luna · Manager</p>
              <p className="text-xs text-muted-foreground">Orchestrates tasks and assigns work</p>
            </div>
            <span className="text-[10px] px-2.5 py-1 rounded-full font-medium whitespace-nowrap bg-emerald-500/15 text-emerald-400 transition-all duration-300">
          ...
          <div className="space-y-3">
            {agents.map((agent) => (
              <div key={agent.role} className="flex items-center gap-3">
                ...
                <span
                  className={`text-[10px] px-2.5 py-1 rounded-full font-medium whitespace-nowrap transition-all duration-300 ${
        ...
        <div className="p-5 sm:p-6">
          ...
          <div className="space-y-3">
            {feed.map((item, i) => (
              <div key={i} className="bg-surface rounded-lg p-3.5 transition-all duration-200">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-center gap-1.5 bg-secondary px-2 py-1 rounded-md shrink-0">
      ...
      <div className="border-t border-border px-5 py-3 flex items-center justify-between">
        <div className="flex flex-wrap gap-1.5">
          {loopSteps.map((step, i) => (
            <span
              key={step}
              className={`text-[10px] px-2 py-1 rounded-full font-medium transition-all duration-300 ${
                currentStep === i
        ...
        <Button onClick={runCycle} disabled={isAnimating} variant="outline" size="sm" className="gap-1.5 ml-4 shrink-0">
